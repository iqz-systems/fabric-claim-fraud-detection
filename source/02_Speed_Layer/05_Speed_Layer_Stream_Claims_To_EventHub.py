"""
================================================================================
NOTEBOOK: 05 - Speed Layer - Stream Claims to Event Hub
================================================================================

PURPOSE:
    Simulates streaming insurance claims to Azure Event Hub for real-time
    processing. Reads claims from lakehouse and sends batches to Event Hub.

WHAT THIS NOTEBOOK DOES:
    1. Reads claims data from lakehouse
    2. Enriches with product information
    3. Streams claims in batches to Azure Event Hub
    4. Tracks streaming position for consistent replay

PREREQUISITES:
    - Azure Event Hub created and configured
    - Event Hub connection string
    - Claims data loaded in raw.frauddetection.claims
    - Products data loaded in raw.frauddetection.products

HOW TO USE:
    1. Copy ALL content from this file
    2. Paste into Fabric notebook
    3. Attach lakehouse
    4. Update EVENT_HUB_CONNECTION_STRING with your connection string
...
CONFIGURATION REQUIRED:
    ...
    - claims_25k.json: Sample claims file (or update path)

EXECUTION ORDER:
    Run after: 01_Data_Preparation_Load_Initial_Data
    Can run: Independently for testing/sample purposes
...
# # 02 - Speed Layer: Stream Claims to Event Hub
# 
# This notebook simulates streaming insurance claims to Azure Event Hub.
# 
# **Use Cases:**
# - Sample/testing real-time claim processing
...
# Fabric Configuration (will be auto-populated when you attach lakehouse)
...
# Claims file path (update to match your file location)
CLAIMS_FILE_PATH = "Files/claims_25k.json"

print("Configuration loaded")
print(f"Event Hub: {EVENT_HUB_NAME}")
print(f"Claims file: {CLAIMS_FILE_PATH}")
...
def read_samples(sample_size: int = 300):
    ...
    claims = spark.read.json(CLAIMS_FILE_PATH)
...
# Adjust sample_size as needed for your sample run
print("Starting to stream claims...")
